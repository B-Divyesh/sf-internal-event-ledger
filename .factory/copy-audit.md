...
Audited 2026-08-30. Counts treat hyphenated terms and prices as one word. No sentence exceeds 22 words and no banned marketing term appears.

| Sentence | Words |
| --- | ---: |
| Review operational events without Slack noise. | 6 |
| For solo developers and small teams that need searchable webhook history without another urgent inbox. | 14 |
...
| Each receiver groups matching events by fingerprint. | 7 |
| Reviewers can search, acknowledge, archive, and export the record. | 9 |
| Create a private JSON receiver and optional signature rule. | 9 |
